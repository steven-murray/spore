...
subroutine grid_visibilities(Nnu,Nbl,Ngrid_u, Ngrid_v, f, visibilities, baselines, ugrid, vgrid, gridded_vis, weights,&
                             radmin,static_beam, sigma0, nthreads )
    implicit none
    ! ==================================================================================================================
    ! grid visibilities
    !
    ...
    write(*,*) "And hellow again(4)"

    write(*,*) rmin, ncells_u, ncells_v, tot_ncells_u, tot_ncells_v
   !$OMP PARALLEL PRIVATE(i,j,n_u,n_v,ui0,uif,vi0,vif,uv,u_ind_min,&
   ...
   !$OMP& NUM_THREADS(nthreads)
    ...
    write(*,*) du, dv, umin, vmin, umax, vmax, Nbl, Nnu
    write(*,*) baselines(1000,:)
